...
import { ActivityIcon, Lock } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-10 max-w-[1200px] h-full items-center justify-center">
      <div className="bg-[#0a0a0a] border border-white/5 p-16 rounded flex flex-col items-center text-center max-w-lg">
        ...
        <h2 className="font-outfit text-2xl font-bold tracking-wide text-white mb-2">Community Analytics</h2>
        <p className="font-inter text-sm text-zinc-400 mb-8 leading-relaxed">
          The comprehensive DAU/MAU and growth tracking module is scheduled for Phase 5. It will visualize deep community engagement and retention metrics.
        </p>
