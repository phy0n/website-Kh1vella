  ...
  return (
    <div className="flex flex-col gap-10 w-full">
      <div className="flex items-center gap-3">
        ...
        <h3 className="font-outfit font-semibold text-lg uppercase tracking-widest">System Analytics</h3>
      </div>
      ...
      <div className="flex flex-col gap-8 flex-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="bg-[#0a0a0a] border border-white/5 p-8">
            <h3 className="font-outfit font-medium text-white text-lg mb-6 flex items-center gap-2 uppercase tracking-widest">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                ...
                <span className="bg-green-500/10 text-green-500 border border-green-500/20 px-2 py-0.5 text-xs font-mono">ONLINE (PostgreSQL)</span>
              </div>
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <span className="font-inter text-sm text-zinc-400">Bot Latency (Ping)</span>
                <span className="bg-zinc-800 text-zinc-300 border border-white/10 px-2 py-0.5 text-xs font-mono">~45ms</span>
              </div>
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <span className="font-inter text-sm text-zinc-400">Uptime</span>
                <span className="bg-zinc-800 text-zinc-300 border border-white/10 px-2 py-0.5 text-xs font-mono">99.9%</span>
              </div>
            </div>
          </div>

          <div className="bg-[#0a0a0a] border border-white/5 p-8 flex flex-col justify-center items-center text-center">
            <Zap className="w-12 h-12 text-zinc-600 mb-4 opacity-50" />
            <h3 className="font-outfit font-medium text-white text-lg mb-2 uppercase tracking-widest">Visual Charts Upcoming</h3>
